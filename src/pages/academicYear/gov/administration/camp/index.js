...
function CampsData() {
  ...
  const sums = camps?.reduce(
    ...
    { total_students: 0, firstExamAttend: 0, secondExamAttend: 0, total_teachers: 0 }
  )

  const { total_students = null, firstExamAttend = null, secondExamAttend = null, total_teachers = null } = sums || {}
