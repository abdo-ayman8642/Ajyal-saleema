...
const DialogEditForm = ({ toggle, showEdit, title, formType, editAction, editData }) => {
  // ** States */
  const dispatch = useDispatch()
  const selectedData = useSelector(state => state.academicData?.selectedData)
  ...
  const customizeSubmit = data => {
    ...
    dispatch(editAction({ data: formData, id: selectedData.id }))
    dispatch(handleSelectedData(null))
    handleClose()
  }
