      ...
      >
        ...
        <Box sx={{ mt: 5, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            <Typography sx={{ mb: 0.75, fontWeight: 600 }}>المحافظات الأكثر مشاركة</Typography>
            <Typography variant='body2'>اجمالي الطلبة من هذه المحافظات 2938098 الف طالب</Typography>
          </Box>
